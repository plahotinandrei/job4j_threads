...
class ParallelSearchTest {
    ...
    public void whenIntegerArrayAndRecursiveThanIndex() {
        ...
        int num = -2;
        ParallelSearch<Integer> numSearch = new ParallelSearch<>();
        assertThat(numSearch.search(nums, num)).isEqualTo(7);
    }
    ...
    public void whenDoubleArrayAndRecursiveThanIndex() {
        ...
        double num = -2D;
        ParallelSearch<Double> numSearch = new ParallelSearch<>();
        assertThat(numSearch.search(nums, num)).isEqualTo(7);
    }
    ...
    public void whenIntegerArrayAndLinearThanIndex() {
        ...
        int num = 9;
        ParallelSearch<Integer> numSearch = new ParallelSearch<>();
        assertThat(numSearch.search(nums, num)).isEqualTo(5);
    }
    ...
    public void whenLongArrayAndRecursiveThanNotFound() {
        ...
        long num = -21;
        ParallelSearch<Long> numSearch = new ParallelSearch<>();
        assertThat(numSearch.search(nums, num)).isEqualTo(-1);
    }
